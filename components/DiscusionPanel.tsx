...
export default function DiscusionPanel() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="label-art text-zona-notificaciones text-xl">Etapa de discusión (arts. 254, 309-314 CPC)</h2>
      ...
      {fase === "demanda_proveida" && (
        <div className="terminal p-5">
          <div className="label-art text-zona-competencia">Demanda proveída con 'traslado'</div>
          <p className="text-doc-aged/70 text-xs mt-2">El demandado tiene su plazo (arts. 258-259). Puede contestar derechamente, oponer dilatorias (art. 303) o reconvenir.</p>
      ...
      {fase === "contestacion" && (
        <div className="terminal p-5">
          <div className="label-art text-zona-competencia mb-2">Excepciones dilatorias opuestas (art. 303 CPC)</div>
          <p className="text-doc-aged/60 text-xs mb-3">Selecciona las que el demandado opone. Recuerda: deben oponerse TODAS EN UN MISMO ESCRITO antes de contestar (art. 305).</p>
      ...
      {fase === "replica" && (
        <div className="terminal p-5">
          <div className="label-art text-zona-competencia">Réplica del actor (art. 311 CPC)</div>
          <p className="text-doc-aged/70 text-xs mt-2">El demandante tiene 6 días para replicar. Puede AMPLIAR, ADICIONAR o MODIFICAR las acciones formuladas, pero sin que pueda alterarlas substancialmente.</p>
      ...
      {fase === "duplica" && (
        <div className="terminal p-5">
          <div className="label-art text-zona-competencia">Dúplica del demandado (art. 312 CPC)</div>
          <p className="text-doc-aged/70 text-xs mt-2">El demandado tiene 6 días para duplicar. Cierra la discusión. Próximo paso: conciliación obligatoria (art. 262).</p>
      ...
      {fase === "cerrada" && (
        <div className="terminal p-5 border-neon-blue">
          <div className="label-art text-zona-notificaciones">✓ Etapa de discusión cerrada</div>
          <p className="text-doc-aged/80 text-xs mt-2">Procede CONCILIACIÓN obligatoria (art. 262 CPC), salvo casos del 263. Recuerda las excepciones perentorias anómalas del art. 310 que pueden oponerse en cualquier estado del juicio hasta antes de la citación a oír sentencia en 1° instancia (y hasta antes de la vista en 2°):</p>
          <ul className="text-xs mt-2 space-y-1">
            {EXCEPCIONES_PERENTORIAS_ANOMALAS.map((e, i) => (
              <li key={i}>• <b className="text-zona-competencia">{e.t}</b> — <span className="tag tag-violet">{e.articulo}</span></li>
            ))}
          </ul>
        </div>
      )}
