...
const MODULOS: {
  ...
  },
  {
    ...
    subtitulo: "ORDEN LEGAL · DRAG & DROP",
    descripcion: "3 escenarios: juicio ejecutivo, ordinario y caos con incidente. Reconstruye el orden correcto de los actos procesales. Respetar el orden = validez. Saltarse pasos = nulidad (art. 768 N°9).",
    zona: "ejecutivo",
    numeral: "ARC.03",
    nuevo: true,
  },
  {
    ...
    descripcion: "Selecciona un medio de prueba (documental, testimonial, confesión, presunción, pericial). Tu oponente elige al azar. Gana quien tenga mayor fuerza. Aprende jerarquía probatoria.",
    zona: "prueba",
    numeral: "ARC.04",
    nuevo: true,
  },
  {
    ...
    descripcion: "8 preguntas de procedimiento con 30 segundos cada una. El tiempo corre. Presión máxima. Responde rápido y correcto. Combina velocidad con precisión doctrinaria.",
    zona: "oralidad",
    numeral: "ARC.05",
    nuevo: true,
  },
  {
    id: "clasificador",
    titulo: "Clasificador de Resoluciones",
    subtitulo: "ARCADE · TIPOS DE SENTENCIA",
    descripcion: "8 resoluciones judiciales. Identifica si es decreto, auto, interlocutoria, o definitiva. Artículos, recursos correctos, plazo. Entender la clasificación = dominar los recursos.",
    zona: "recursos",
    numeral: "ARC.06",
    nuevo: false,
  },
  {
    id: "notificador",
    titulo: "Notificador Maldito",
    subtitulo: "ARCADE · EVENTOS CAÓTICOS",
    descripcion: "5 pasos de modalidades de notificación con eventos aleatorios que interfieren. Demandado escondido, domicilio ambiguo, hora inválida. Gestiona cada complicación.",
    zona: "ejecutivo",
    numeral: "ARC.07",
    nuevo: false,
  },
  ...
  if (m !== "menu") {
    return (
      <main className="min-h-screen px-4 md:px-8 py-6 max-w-6xl mx-auto">
        ...
        {m === "timeline" && <TimelineProcesal />}
        {m === "duelo" && <DueloMediosPrueba />}
        {m === "ataque" && <AtaqueRepreguntas />}
        {m === "clasificador" && <ClasificadorResoluciones />}
        {m === "notificador" && <NotificadorMaldito />}
