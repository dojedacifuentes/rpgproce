...
export const ALTERNATIVAS_DIFICIL: AlternativaDificil[] = [
  {
    ...
    enunciado: "Una sentencia definitiva de segunda instancia, pronunciada por una Corte de Apelaciones, contiene una sección de fundamentos contradictorios entre sí. ¿Cuál es la causal de casación en la forma que corresponde invocar?",
    opciones: [
      { letra: "A", texto: "Art. 768 N°5 CPC: haber sido pronunciada con omisión de cualquiera de los requisitos enumerados en el art. 170 CPC." },
      { letra: "B", texto: "Art. 768 N°6 CPC: haber sido pronunciada contra otra sentencia pasada en autoridad de cosa juzgada." },
      { letra: "C", texto: "Art. 768 N°4 CPC: haber sido dada ultra petita." },
      { letra: "D", texto: "Art. 768 N°7 CPC: contener decisiones contradictorias." },
    ],
    correcta: "A",
    explicacion: "Los fundamentos contradictorios constituyen incumplimiento del requisito del art. 170 N°4 CPC (consideraciones de hecho y derecho) y del Auto Acordado de 1920. La causal es el N°5 del art. 768 (omisión de requisitos del art. 170), no el N°7. El N°7 se refiere a decisiones contradictorias en la parte resolutiva, no en los fundamentos. El error común es confundir los fundamentos con la parte decisoria.",
    normas: ["Art. 768 N°5 CPC", "Art. 170 N°4 CPC"],
    zona: "recursos",
  },
  {
    id: "alt_02",
    tema: "Ejecutivo — Tercerías",
    enunciado: "En el marco de un juicio ejecutivo, el cónyuge del ejecutado alega que el bien embargado es un bien familiar declarado conforme al art. 141 CC. ¿Cuál tercería debe interponer?",
    opciones: [
      { letra: "A", texto: "Tercería de dominio, porque el cónyuge es co-propietario del bien familiar." },
      { letra: "B", texto: "Tercería de posesión, porque tiene la tenencia material del inmueble." },
      { letra: "C", texto: "Tercería de prelación, para cobrar su crédito con preferencia sobre el ejecutante." },
      { letra: "D", texto: "Tercería de dominio, porque la declaración de bien familiar le confiere un derecho real oponible." },
    ],
    correcta: "D",
    explicacion: "La declaración de bien familiar (art. 141 CC) no confiere copropiedad per se, pero sí un derecho real de habitación y uso que es oponible erga omnes. El cónyuge no propietario adquiere un derecho real sobre el inmueble que justifica la tercería de dominio (art. 518 N°1 CPC). No es tercería de posesión porque la protección no es posesoria sino real. La tercería de prelación solo aplica cuando hay crédito preferente que cobrar del mismo bien.",
    normas: ["Art. 141 CC", "Art. 518 CPC", "Art. 519 CPC"],
    zona: "ejecutivo",
  },
  {
    id: "alt_03",
    tema: "Medidas precautorias — Caución",
    enunciado: "El demandante solicitó una medida precautoria de retención de cuentas corrientes sin acompañar los comprobantes del art. 298 CPC. El tribunal la decretó condicionada a que el solicitante rinda caución. ¿Es esto procedente?",
    opciones: [
      { letra: "A", texto: "No, porque el art. 298 exige comprobantes como requisito sine qua non y no puede suplirse con caución." },
      { letra: "B", texto: "Sí, pero solo si el demandado consiente en la medida." },
      { letra: "C", texto: "Sí, el tribunal puede decretar la medida bajo caución cuando no se acompañan los comprobantes, como medida provisional." },
      { letra: "D", texto: "No, porque la caución solo procede en las medidas innominadas del art. 298 inc. 2°." },
    ],
    correcta: "C",
    explicacion: "El art. 299 CPC permite al tribunal, cuando los motivos sean graves y justificados, decretar la medida precautoria sin los comprobantes del art. 298, pero exigiendo caución al solicitante para responder de los perjuicios que la medida cause si la demanda no prospera. Esto es la medida precautoria provisional, que puede decretarse incluso antes de la notificación de la demanda (art. 302 CPC). La caución suple el requisito del fumus boni iuris cuando este no puede acreditarse de inmediato.",
    normas: ["Art. 298 CPC", "Art. 299 CPC", "Art. 302 CPC"],
    zona: "cautelares",
  },
  {
    id: "alt_04",
    tema: "Recursos — Apelación adhesiva",
    enunciado: "El demandado apeló de la sentencia de primera instancia. El demandante no apeló dentro del plazo legal. Sin embargo, en segunda instancia el demandante desea impugnar ciertos aspectos de la sentencia que le son desfavorables. ¿Qué recurso procesal puede ejercer?",
    opciones: [
      { letra: "A", texto: "No puede hacer nada: el plazo de apelación está precluido y no puede incorporarse al recurso del demandado." },
      { letra: "B", texto: "Puede adherirse a la apelación del demandado mediante apelación adhesiva o incidental, conforme al art. 217 CPC." },
      { letra: "C", texto: "Puede interponer recurso de casación en la forma directamente ante la Corte de Apelaciones." },
      { letra: "D", texto: "Puede ampliar la apelación del demandado a través de la figura del litisconsorcio procesal." },
    ],
    correcta: "B",
    explicacion: "El art. 217 CPC contempla la apelación adhesiva (o incidental): la parte que no apeló en el plazo legal puede adherirse a la apelación del contrario al comparecer en segunda instancia, siempre que haya habido apelación de la otra parte. La adhesión debe hacerse dentro del plazo para comparecer ante el tribunal de alzada. Solo puede referirse a los puntos de la sentencia que sean desfavorables para el adherente. Si el apelante principal desiste o abandona su recurso, la adhesión también caduca.",
    normas: ["Art. 217 CPC"],
    zona: "recursos",
  },
  {
    id: "alt_05",
    tema: "Prueba — Presunciones",
    enunciado: "En juicio de responsabilidad extracontractual, el demandante alega que el demandado incurrió en culpa. ¿Cuál de las siguientes afirmaciones sobre la carga probatoria es correcta?",
    opciones: [
      { letra: "A", texto: "El demandante debe probar la culpa, el daño y el nexo causal, sin excepción." },
      { letra: "B", texto: "En el régimen del art. 2329 CC existe una presunción general de culpa por hecho propio que invierte el onus." },
      { letra: "C", texto: "El demandado debe probar que actuó con la diligencia debida, porque la culpa se presume en toda responsabilidad civil." },
      { letra: "D", texto: "El demandante solo debe probar el daño; la culpa se presume si el daño es de cierta entidad." },
    ],
    correcta: "A",
    explicacion: "En la responsabilidad extracontractual del art. 2314 CC, la regla general es que el demandante debe probar: (1) el hecho ilícito, (2) la culpa o dolo del demandado, (3) el daño y (4) el nexo causal. No existe una presunción general de culpa en el régimen del art. 2314. El art. 2329 CC contempla presunciones específicas de culpa (por hecho de cosas animadas e inanimadas), pero no es una presunción general. La culpa se presume en responsabilidad CONTRACTUAL (art. 1547 CC), no extracontractual.",
    normas: ["Art. 2314 CC", "Art. 2329 CC", "Art. 1547 CC", "Art. 1698 CC"],
    zona: "prueba",
  },
  {
    id: "alt_06",
  ...
  {
    id: "alt_07",
    tema: "Juicio Ejecutivo — Prescripción",
    enunciado: "El ejecutado alega prescripción de la acción ejecutiva. El título es una sentencia definitiva ejecutoriada dictada hace 4 años. ¿Procede la excepción?",
    opciones: [
      { letra: "A", texto: "Sí, porque la acción ejecutiva prescribe en 3 años conforme al art. 2515 CC." },
      { letra: "B", texto: "No, porque las sentencias definitivas dan origen a la acción de cosa juzgada que prescribe en 3 años." },
      { letra: "C", texto: "No, porque la acción para ejecutar una sentencia firme no prescribe mientras se mantenga la cosa juzgada." },
      { letra: "D", texto: "Sí, pero solo si el ejecutado lo alega expresamente, porque el tribunal no puede declararla de oficio respecto de acciones de cosa juzgada." },
    ],
    correcta: "A",
    explicacion: "La acción ejecutiva prescribe en 3 años (art. 2515 inc. 2° CC), transformándose luego en ordinaria por 2 años más. Esto aplica a toda acción ejecutiva, incluida la derivada de una sentencia firme. El art. 442 CPC ordena al tribunal examinar de oficio la prescripción del título cuando este tiene más de 3 años. Por lo tanto, si la sentencia fue dictada hace 4 años, la acción ejecutiva está prescrita y el tribunal debe declararla de oficio si advierte el vencimiento, o el ejecutado puede alegarla como excepción del art. 464 N°17.",
    normas: ["Art. 2515 CC", "Art. 442 CPC", "Art. 464 N°17 CPC"],
    zona: "ejecutivo",
  },
  {
    id: "alt_08",
    tema: "Competencia — Árbitros",
    enunciado: "Las partes someten a arbitraje un conflicto societario. El árbitro dicta sentencia. El litigante vencido desea impugnarla mediante casación en la forma. ¿Es procedente?",
    opciones: [
      { letra: "A", texto: "Sí, siempre procede la casación en la forma contra sentencias arbitrales, ante la Corte de Apelaciones respectiva." },
      { letra: "B", texto: "Solo procede si el árbitro es de derecho; en arbitraje de equidad, las partes pueden haber renunciado a los recursos." },
      { letra: "C", texto: "No procede casación contra sentencias arbitrales; solo procede recurso de queja." },
      { letra: "D", texto: "Procede siempre casación en el fondo ante la Corte Suprema, pero nunca casación en la forma." },
    ],
    correcta: "B",
    explicacion: "Conforme al art. 239 COT y el art. 795 CPC, los árbitros de derecho deben tramitar conforme a las reglas del procedimiento ordinario y sus sentencias son susceptibles de los mismos recursos que las sentencias judiciales, salvo renuncia de las partes. Los árbitros arbitradores (de equidad) pueden resolver sin sujetarse a formas legales y las partes pueden renunciar a los recursos, incluida la casación (art. 242 COT). La casación en la forma contra sentencia arbitral se interpone ante la Corte de Apelaciones que habría conocido del asunto si no fuera arbitral.",
  ...
  },
  {
    ...
    enunciado: "Pedro demanda a Juan por incumplimiento de contrato y obtiene sentencia condenatoria. Tiempo después, Pedro intenta demandar al fiador de Juan por la misma deuda. ¿Puede el fiador oponer la cosa juzgada del juicio anterior?",
    opciones: [
      { letra: "A", texto: "Sí, porque hay identidad de causa de pedir (el mismo contrato) y de objeto pedido (el mismo monto)." },
      { letra: "B", texto: "No, porque el fiador es un tercero que no fue parte en el juicio anterior; no hay identidad legal de personas." },
      { letra: "C", texto: "Sí, porque la sentencia contra el deudor principal es oponible erga omnes como cosa juzgada absoluta." },
      { letra: "D", texto: "Depende: si el fiador intervino como tercero coadyuvante en el primer juicio, puede oponer la cosa juzgada." },
    ],
    correcta: "B",
    explicacion: "La cosa juzgada requiere triple identidad, siendo la identidad legal de personas uno de los requisitos (art. 177 CPC). El fiador es un tercero respecto al juicio entre Pedro y Juan. Por tanto, no existe identidad legal de personas entre Juan y el fiador. La sentencia que condena al deudor principal no produce cosa juzgada contra el fiador porque este no fue parte. Sin embargo, el art. 2354 CC permite al fiador oponer todas las excepciones reales del deudor (incluyendo las que este tenía contra el acreedor), lo que es distinto de la cosa juzgada.",
    normas: ["Art. 177 CPC", "Art. 2354 CC", "Art. 2370 CC"],
    zona: "cosajuzgada",
  },
  {
    id: "alt_10",
