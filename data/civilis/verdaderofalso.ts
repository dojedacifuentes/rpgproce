...
export const VOF_CIVIL: AfirmacionVoF[] = [
  ...
  { id: "vof_17", texto: "La dación en pago crea una nueva obligación que reemplaza a la anterior.", verdadero: false, explicacion: "La dación en pago extingue pagando con una cosa distinta aceptada; no crea obligación nueva (eso sería novación).", articulo: "Dación en pago", region: "extincion" },
  { id: "vof_18", texto: "La responsabilidad extracontractual nace de un delito o cuasidelito civil.", verdadero: true, explicacion: "El art. 2314 funda la responsabilidad por el hecho ilícito dañoso sin contrato previo.", articulo: "Art. 2314 CC", region: "contratos" },
  { id: "vof_19", texto: "Por regla general el mandato continúa con los herederos tras la muerte del mandante.", verdadero: false, explicacion: "Por regla general el mandato termina con la muerte (2163 N°5), salvo excepciones.", articulo: "Art. 2163 CC", region: "mandato" },
  { id: "vof_20", texto: "La compraventa de bienes raíces es solemne y requiere escritura pública.", verdadero: true, explicacion: "Por excepción, la CV de inmuebles, servidumbres, censos y sucesiones es solemne.", articulo: "Art. 1801 CC", region: "compraventa" },
  { id: "vof_21", texto: "La remisión o condonación de la deuda extingue la obligación.", verdadero: true, explicacion: "Es la renuncia gratuita del acreedor a su crédito (1652).", articulo: "Art. 1652 CC", region: "extincion" },
  { id: "vof_22", texto: "En la teoría de la imprevisión la prestación se vuelve imposible de ejecutar.", verdadero: false, explicacion: "No se vuelve imposible (eso es caso fortuito), sino excesivamente onerosa.", articulo: "Imprevisión", region: "contratos" },
];
